...
\begin{figure}
\centering
\psfig{file=ray_trace_diagram.png,width =3in}
...
\begin{figure}
\centering
\psfig{file=400px-Z-curve.png,width =3in}
...
\begin{figure}
\centering
\psfig{file=radix_cores.pdf,width =3in}
...
\begin{figure}
\centering
\psfig{file=radix_bvh_time.pdf,width =3in}
